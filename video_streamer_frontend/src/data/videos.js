const videos = [
  ...
  // Remaining list (verified, embeddable; stable sddefault/hqdefault thumbs from official channels)
  // Cocomelon (official)
  ...
  // Peppa Pig - official channel clips
  ...
  // Bluey - official channel shorts/clips (generally embeddable)
